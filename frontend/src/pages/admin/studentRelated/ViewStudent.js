...
const ViewStudent = () => {
    ...
    useEffect(() => {
        if (userDetails && userDetails.batchName && userDetails.batchName._id !== undefined) {
    ...
    const [batchName, setSclassName] = useState('');
    ...
    useEffect(() => {
        if (userDetails) {
            ...
            setSclassName(userDetails.batchName || '');
    ...
    const hostelData = Object.entries(groupAttendanceByHostel(hostelAttendance)).map(([subName, { subCode, present, sessions }]) => {
                                    ...
                                    <StyledTableRow>
                                        ...
                                        <StyledTableCell align="center">
                                            ...
                                            <Button variant="contained" sx={styles.attendanceButton}
                                                onClick={() => navigate(`/Admin/hostel/student/attendance/${studentID}/${subId}`)}>
                                                Change
                                            </Button>
                                        </StyledTableCell>
                                    </StyledTableRow>
    ...
    const StudentMarksSection = () => {
        ...
        const renderChartSection = () => {
            return (
                <>
                    <CustomBarChart chartData={hostelMarks} dataKey="marksObtained" />
                </>
            )
        }
        return (
