...
import Hostel from "../../assets/hostels.svg";
...
const StudentHomePage = () => {
    ...
    const batchID = currentUser.batchName._id

    useEffect(() => {
        dispatch(getUserDetails(currentUser._id, "Student"));
        dispatch(getHostelList(batchID, "BatchHostels"));
    }, [dispatch, currentUser._id, batchID]);

    const numberOfHostels = hostelsList && hostelsList.length;
                ...
                <Grid container spacing={3}>
                    <Grid item xs={12} md={3} lg={3}>
                        <StyledPaper>
                            ...
                            <Data start={0} end={numberOfHostels} duration={2.5} />
                        </StyledPaper>
                    </Grid>
                    <Grid item xs={12} md={3} lg={3}>
                        <StyledPaper>
